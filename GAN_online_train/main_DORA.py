...
for DORA results shown in Figure 5e. For clarity and ease 
...
if __name__ == "__main__":
    ...
    assign_ACIM_layers = [
        'initial.3.conv',               # -> ACIM core
        'prog_blocks.0.conv1.conv',     # -> ACIM core
        'prog_blocks.0.conv2.conv',     # -> ACIM core
        'prog_blocks.1.conv1.conv',     # -> ACIM core
        'prog_blocks.1.conv2.conv',     # -> ACIM core
        'prog_blocks.2.conv1.conv',     # -> ACIM core
        'prog_blocks.2.conv2.conv',     # -> ACIM core
        'prog_blocks.3.conv1.conv',     # -> ACIM core
        'prog_blocks.3.conv2.conv',     # -> ACIM core
        'prog_blocks.4.conv1.conv',     # -> ACIM core
        'prog_blocks.4.conv2.conv',     # -> ACIM core
    ]
    ...
    # Add digital channel and adapters
    gan.add_enhance_branch_LoR(rank_factor = 1 / 8)
    gan.add_enhance_layers()
    ...
    # =========================== #
    gen_model_name = fr'pretrained_model/generator_w_4b_o_8b_DORA.pth'
    critic_model_name = fr'pretrained_model/critic_w_4b_o_8b_DORA.pth'
    ...
    # gan.export_onnx(input_data, onnx_path = f'GAN_DORA')
    # =========================== #
    # Mapping ACIM weights
    # =========================== #
    model_weight_mapping_info = map_weight_for_model(gan.model,
                                                     draw_folder = 'Array_Mapping_Info_DORA',
                                                     array_size = [576, 128],
